		...
		<!-- Wrapper -->
			<div id="wrapper" class="fade-in">
				...
				<!-- Intro -->
					<div id="intro">
						<h1>Hi, I'm Wil :)</h1>
						<p>I am a developer that loves creating games and applications for people to enjoy</p>
					...
					<div id="main">
						...
						<!-- Details -->
							<section>
								...
								<p>I decided to use unity due to its versatility and prevalence at the time over other engines and self-taught all of my skills, starting off with <a href="https://www.youtube.com/channel/UCYbK_tjZ2OrIZFBvU6CCMiA" target="_blank" rel="noopener noreferrer">Brackeys' tutorials</a> and moving from there.</p>
								<!-- Skills -->
								<h2>Skills</h2>								
				...
				<!-- Copyright -->
					<div id="copyright">
						<ul><li>&copy; 2024 William Schack</li><li>Design: <a href="https://html5up.net">HTML5 UP</a></li></ul>
					</div>
